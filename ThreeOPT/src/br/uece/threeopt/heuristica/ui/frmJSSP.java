...
public class frmJSSP extends JFrame {
	...
	private void inicializaComponentes() {
		...
		Button btnGeraSolucao = new Button("Gerar solu��o");
		panel.add(label1);
		...
		label3.setText("Solu��o Menor Caminho: ");
	...
	/*private void btnGeraSolucaoArquivoActionPerformed(java.awt.event.ActionEvent evento) {
		...
		if (file == null) {
			JOptionPane.showMessageDialog(this, "Antes de gerar a solu��o, � necess�rio escolher um arquivo.");
		} else {
			geraSolucao();
		}
	}*/
